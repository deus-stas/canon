import { fetchPublications as fetchPublicationsFromServer } from '@/api'
...
export const fetchPublications = (region, lang) => (dispatch, getState) => {
  const {
  ...
  if (state !== STATES.LOADING) {
    ...
    fetchPublicationsFromServer(region, lang)
