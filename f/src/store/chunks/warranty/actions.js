import { fetchWarranty as fetchWarrantyFromServer, saveFeedbackForm as saveWarrantyOnServer } from '@/api'
...
export const fetchWarranty = lang => (dispatch, getState) => {
  const {
